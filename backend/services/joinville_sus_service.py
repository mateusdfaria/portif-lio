...
class JoinvilleSusService:
    ...
    def _load_joinville_hospitals(self) -> List[JoinvilleSusHospital]:
        """Carrega hospitais públicos de Joinville"""
        hospitals_data = [
            {
    ...
    def get_sus_data(self, cnes: str, start_date: str, end_date: str) -> List[JoinvilleSusData]:
        ...
        try:
            ...
            # Se não conseguir dados reais, usar dados baseados em padrões SUS
            logger.warning("Usando dados baseados em padrões SUS")
